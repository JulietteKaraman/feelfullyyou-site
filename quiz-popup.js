(function(){
  ...
  function build(){
    ...
    overlay.innerHTML =
      ...
      + '<h3>What&rsquo;s your Touch Pattern?</h3>'
      + '<p>Intimacy doesn&rsquo;t come back through spontaneity. It comes back through structure. Meet the pattern your body is already running.</p>'
